              ...
              <div class="box-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-info -->
                    <img class="direct-chat-img" src="<?=base_url('assets')?>/dist/img/user2-160x160.jpg" alt="message user image"><!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-info -->
                    <img class="direct-chat-img" src="<?=base_url('assets')?>/dist/img/user4-128x128.jpg" alt="message user image"><!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
              ...
              <div class="box-body no-padding">
                <ul class="users-list clearfix">
                  ...
                  <li>
                    ...
                    <a class="users-list-name" href="#">Rosse</a>
                  ...
                  <li>
                    ...
                    <a class="users-list-name" href="#">Mustofa</a>
                    <span class="users-list-date">13 Jan</span>
                  </li>
                  <li>
                    <img src="<?=base_url('assets')?>/dist/img/user2-160x1601.jpg" alt="User Image">
                    <a class="users-list-name" href="#">Pierce</a>
