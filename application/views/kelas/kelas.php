...
<script type="text/javascript">
	...
	function edit_kelas(id_kelas)
	{
	    ...
	    $.ajax({
	        url : "<?php echo site_url('kelas/kelas_edit/')?>/" + id_kelas,
	        type: "GET",
	        dataType: "JSON",
	        ...
	        {
	            alert('Error get data from kelas');
	        }
	    });
	}
	...
	function delete_kelas(id_kelas)
	{
	    if(confirm('Are you sure delete this data?'))
	    {
	        ...
	        $.ajax({
	            url : "<?php echo site_url('kelas/kelas_delete')?>/"+id_kelas,
	            type: "POST",
	            dataType: "JSON",
	            success: function(data)
	            {
	...
	function show_detail(id_kelas, nama, jml_sks, ipk)
	{
	 	save_method = 'show';
	    ...
	    //Ajax Load data from ajax
	    $.ajax({
	        url : "<?php echo site_url('kelas/detail_show/')?>/" + id_kelas,
	        type: "GET",
	        dataType: "JSON",
	...
	function save()
	{
	    ...
	    var url;
	    if(save_method == 'show') {
	        url = "<?php echo site_url('kelas/detail_show')?>";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Nilai kelas</h3>
            </div>
